                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                                ...
                                <View style={{ flex: 5, }}>
                                    <View style={styles.imageRowView}>
                                        ...
                                        <TouchableOpacity style={styles.threeDotsView} onPress={() => { props.navigation.navigate('StartupUpload') }}>
                                                ...
                                                <View style={{ position: 'relative', }}>
                                                    ...
                                                    {selectedItemId === item[0].article_id && (
                                                        ...
                                                        >
                                                            ...
                                                            <TouchableOpacity onPress={() => { setSelectedItemId(null), props.navigation.navigate('StartupEditArticle', { id: item[0].article_id, cat: item.category_id, desc: item[0].description, title: item[0].title, category: item[0].category_data }) }} style={{ marginTop: 7, marginBottom: 3 }}>
                                                                <Text
