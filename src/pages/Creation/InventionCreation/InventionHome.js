...
const InventionHome = (props) => {
  ...
  const generateThumb = async (item) => {
    console.log('type for the fundraiser', item[1].type);
    setLoading2(true);
                      ...
                      <View style={styles.flatlistBottomView}>
                        ...
                        < View style={styles.buttonsContainer} >
                          <View style={{
                            ...
                            {/* <View style={{ backgroundColor: '#FFC40C', height: 35, width: 35, borderRadius: 20, alignSelf: 'center' }} >
                          ...
                          {typeArticle == 'Fundraiser' ? < View >
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, paddingVertical: 3, width: dimensions.SCREEN_WIDTH * 0.60 }}>
                              <Text style={{ fontSize: 14, color: 'black', fontWeight: '500' }}>{item.total_amount_raised} <Text style={{ fontSize: 14, color: 'gray', fontWeight: '400' }}> USD</Text></Text>
                              <Text style={{ fontSize: 14, color: 'black', fontWeight: '500' }}>{23} <Text style={{ fontSize: 14, color: 'gray', fontWeight: '400' }}>backers</Text></Text>
                            </View>
                            <ProgressBar height={15} width={dimensions.SCREEN_WIDTH * 0.60} backgroundColor={'#E0E0E0'} borderColor={'#E0E0E0'} progress={progress} color={'#FFC40C'} borderRadius={10} />
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 3, paddingHorizontal: 3 }}>
                              <Text style={{ fontWeight: '400', fontSize: 14, color: 'black' }}>{(progress * 100).toFixed(0)}% of {'$' + totalAmount} <Text style={{ fontSize: 14, color: 'black', fontWeight: '500', }}></Text></Text>
                              <Text style={{ fontSize: 14, color: 'black', fontWeight: '500' }}>{10}<Text style={{ fontSize: 14, color: 'gray', fontWeight: '400' }}> days left</Text> </Text>
                            </View>
                          </View> : null
                          }
                        </View>
