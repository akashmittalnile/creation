            ...
            return (
                <View>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: dimensions.SCREEN_WIDTH * 0.90, paddingVertical: 3, paddingHorizontal: 15, marginBottom: 12 }}>
                        ...
                        <Text style={{ fontSize: 14, color: 'black', fontWeight: '500' }}>{Math.floor(Math.floor((new Date(file.expiry)) - new Date()) / (1000 * 60 * 60 * 24))}<Text style={{ fontSize: 14, color: 'gray', fontWeight: '400' }}> days left</Text> </Text>
                    </View>
                </View>
