...
const AllInventionSuggested = (props, route) => {
    ...
    const ArtAll = async () => {
        setLoading(true)
        var fUrl = creation_startup + `?page_no=${1}&limit=10`;
        console.log('my url---------->', art_HomePage)
...
export default AllInventionSuggested 