                                                ...
                                                <View style={{ position: 'relative', }}>
                                                    ...
                                                    {selectedItemId === item[0].article_id && (
                                                        ...
                                                        >
                                                            ...
                                                            <TouchableOpacity onPress={() => { setSelectedItemId(null), props.navigation.navigate('InventionEditArticle', { id: item[0].article_id, cat: item.category_id, desc: item[0].description, title: item[0].title, category: item[0].category_data }) }} style={{ marginTop: 7, marginBottom: 3 }}>
                                                                <Text
                                                ...
                                                <View>
                                                    ...
                                                    {item[0].post == 'Fundraiser' ? < View >
                                                        ...
                                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: dimensions.SCREEN_WIDTH * 0.90, paddingVertical: 3, paddingHorizontal: 15, marginBottom: 12 }}>
                                                            ...
                                                            <Text style={{ fontSize: 14, color: 'black', fontWeight: '500' }}>{Math.floor(Math.floor((new Date(item[0].expiry_date)) - new Date()) / (1000 * 60 * 60 * 24))}<Text style={{ fontSize: 14, color: 'gray', fontWeight: '400' }}> days left</Text> </Text>
                                                        </View>
                                                    </View> : null
                                                    }
                                                </View>
